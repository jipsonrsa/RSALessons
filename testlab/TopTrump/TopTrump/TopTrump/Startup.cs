...
using TopTrump.ViewModels;
using TopTrump.Helpers;
using TopTrump.Policies;
...
namespace TopTrump
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["Data:DefaultConnection:ConnectionString"], b => b.MigrationsAssembly("TopTrump"));
